export const bills = [{
  ...
  "date": "2004-04-04",
  // J'ai rajouté cette valeur ici pour chaque note de frais puisque la fonction de test utilise ces données pour son test
  "dateForSort": "2004-04-04",
  "amount": 400,
  "commentAdmin": "ok",
  "email": "a@a",
  "pct": 20
